...
export default function ComparisonExportFilterPanel({ make, model, onClose }: ComparisonExportFilterPanelProps) {
  ...
  const handleSavePreset = async () => {
    ...
    await savePreset.mutateAsync({ name: presetName.trim(), filterJson: JSON.stringify({ make, model }), presetType: 'comparison' });
    setPresetName('');
  ...
  const handleRenamePreset = async (id: bigint) => {
    ...
    await updatePreset.mutateAsync({ id, name: renameValue.trim(), filterJson: '{}', presetType: 'comparison' });
    setRenamingId(null);
    setRenameValue('');
  };
