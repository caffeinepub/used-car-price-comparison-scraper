  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <p className="text-muted-text text-sm max-w-md mb-2 leading-relaxed">
        Start building your car market database. Add listings manually one by
        one, or import a CSV file to bulk-load hundreds of vehicles at once.
      </p>
      <p className="text-muted-text/60 text-xs max-w-sm mb-8">
        Once you have listings, you'll see price statistics, deal scores, and
        market trends right here.
      </p>
      ...
      <p className="mt-8 text-xs text-muted-text/40">
        Tip: Use the CSV import to add multiple listings from AutoTrader,
        Cars.com, or any source at once.
      </p>
    </div>
  );
}
