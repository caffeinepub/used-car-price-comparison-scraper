...
import type { CrossModelResult as _CrossModelResult, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
...
async function from_candid_CrossModelResult_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CrossModelResult): Promise<CrossModelResult> {
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CrossModelResult>): Promise<Array<CrossModelResult>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CrossModelResult_n14(_uploadFile, _downloadFile, x)));
}
